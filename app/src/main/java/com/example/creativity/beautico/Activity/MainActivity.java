...
/*      toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        tabLayout.setAlpha((float) .4);

//      tabLayout.setTabGravity(Gravity.BOTTOM);
        tabLayout.setupWithViewPager(viewPager);
//        tabLayout.setTabTextColors(Color.parseColor("#FFF"));
//        tabLayout.setTabTextColors(ContextCompat.getColor(context, R.color.white)
...
/*        if (id == R.id.nav_camera) {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentSalon(), "Boutique");
        adapter.addFragment(new FragmentYourPlace(), "Stitching");
